...
const get_cart_controller_1 = __importDefault(require("../controllers/Payment-controller/get-cart-controller"));
...
router.get('/cart/:customerId', get_cart_controller_1.default);

...
let auth = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const login = yield AdminServices_1.default.login(new AuthDto_1.default(Email, contraseña));
        if (login.logged) {
            return res.status(200).json({
                status: login.status,
                token: (0, generateToken_1.default)({ id: login.id, role: "admin" }, process.env.KEY_TOKEN, 6)
            });
        }

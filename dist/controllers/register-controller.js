...
let register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const registerUser = yield UserServices_1.default.register(new RegisterCustomerDto_1.default(nombre, apellido1, apellido2, direccion, calle, carrera, email, contraseña));

...
const DeleteAdminDto_1 = __importDefault(require("../Dto/DeleteAdminDto"));
const delete_admin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { apellido, email } = req.body;
        const delteAdmin = yield AdminServices_1.default.deleteAdmin(new DeleteAdminDto_1.default(apellido, email));

...
const DeleteCustomersDto_1 = __importDefault(require("../../Dto/Customer-Dto/DeleteCustomersDto"));
const delete_customer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { Apellidos, Email } = req.body;
        const deleteCustomer = yield CustomerServices_1.default.deleteCustomer(new DeleteCustomersDto_1.default(Apellidos, Email));

...
const RegisterProductDto_1 = __importDefault(require("../Dto/RegisterProductDto"));
...
let update_Product = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id, nombre, precio, caracteristicas } = req.body;
        const updateProduct = yield ProductServices_1.default.UpdateProduct(new RegisterProductDto_1.default(id, nombre, precio, caracteristicas));

...
const RegisterAdminDto_1 = __importDefault(require("../../Dto/Admin-Dto/RegisterAdminDto"));
...
let register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const registerAdmin = yield AdminServices_1.default.register(new RegisterAdminDto_1.default(Nombres, Apellidos, Email, contraseña));

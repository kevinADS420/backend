...
exports.getProveedorByEmail = void 0;
const config_db_1 = __importDefault(require("../../config/config-db"));
const getProveedorByEmail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [proveedorResult] = yield config_db_1.default.execute('SELECT id_proveedor, nombres, apellidos, Email FROM Proveedor WHERE Email = ?', [email]);
...
exports.getProveedorByEmail = getProveedorByEmail;
